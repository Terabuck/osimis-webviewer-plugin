...
docker-compose -f $TEST_COMPOSE_FILE -p $TEST_COMPOSE_PROJECT create --build --force-recreate # do not use --force-recreate (invalidate images cache - not stated in doc)
