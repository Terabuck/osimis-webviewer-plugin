...
awsContainerId=$(docker create -e AWS_ACCESS_KEY_ID=$AWS_ACCESS_KEY_ID -e AWS_SECRET_ACCESS_KEY=$AWS_SECRET_ACCESS_KEY anigeo/awscli s3 --region eu-west-1 cp /toolbox/$zipFileToUpload.zip s3://orthanc.osimis.io/public/osimisWebViewer/)
