...
angular.module('webviewer')
  .directive('wvStudylist', ['orthancApiService', function (orthancApiService) {
    return {
      ...
      template: '<button type="button" class="btn btn-default wv-button wv-studylist" ng-model="wvSelectedStudy" placeholder="Study.." bs-options="study.value as study.label for study in studies" bs-select></button>',
      restrict: 'E',
